...
export default async function EditPlayerStoryPage({
  params,
}: {
  params: { id: string };
}) {
      ...
      <section className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl font-bold mb-8">Edit Player Story</h1>

            <StoryEditForm story={story} type="player" />
          </div>
        </div>
      </section>
